...
public interface GameInterface
{
     ...
     * This method should get ask players for ship placements. The board that is passed to the players when choosing placements should be a clone of the game board so that they can
     * try out moves without affecting the state of the game. Once ships are all placed the players should be asked one after another for their choice of shot via their getShot method. 
     ...
     * 
     * @return the winning player if there is one, or null if not (the game has been paused by a player). If a player tries to take an illegal shot or place a ship illegally then 
     * they forfeit the game and the other player immediately wins.
     *
     **/
